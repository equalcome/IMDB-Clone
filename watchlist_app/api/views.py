...
# class ReviewDetail(mixins.RetrieveModelMixin, generics.GenericAPIView): #GET single
#     queryset = Review.objects.all()
...
# class ReviewList(mixins.ListModelMixin,  #GET
...
#         queryset = StreamPlatform.objects.all()
#         watchlist = get_object_or_404(queryset, pk=pk) #不覺得是watchlist 應是srteam
...
#         serializer = MovieSerializer(movies, many=True)  #serializer == object #dict(Python datatype)
#         return Response(serializer.data) #JSON

#     if request.method == 'POST':
#         serializer = MovieSerializer(data=request.data)
#         if serializer.is_valid():
#             serializer.save()   #auto call create()
#             return Response(serializer.data)
#         else:
#             return Response(serializer.errors)
...
#         if serializer.is_valid():
#             serializer.save() #auto call update()
#             return Response(serializer.data)
#         else:
#             return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
